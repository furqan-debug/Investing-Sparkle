    ...
    <>
      <section className="bg-green-950 text-white">
        <div className="container-page py-16 md:py-24">
          <p className="eyebrow animate-fade-in text-sparkle-400">Advisory</p>
      ...
      <Section tone="white" id="compare">
                ...
                <tr>
                  ...
                  {services.map((s) => (
                    <th key={s.slug} scope="col" className="p-4 align-bottom">
                      <span className="block font-display text-2xl text-green-800">
                        {s.shortName}
                      </span>
                    </th>
                  ))}
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2">
          ...
          <p className="rounded-2xl border border-sparkle-300 bg-sparkle-50 p-5 text-sm font-medium leading-relaxed text-ink">
            {upgradeNote}
          </p>
        </div>
        ...
        <p className="mt-6 text-sm text-muted">
          ...
          <a
            ...
            className="link-hover font-semibold text-green-700"
          >
            Ask us on WhatsApp
          </a>{' '}
          and we will tell you honestly, including if the answer is &ldquo;none of them yet&rdquo;.
        </p>
      </Section>
      ...
      <Section tone="paper">
        ...
        <div className="mt-10 space-y-6">
          {services.map((s, idx) => (
            <ScrollReveal key={s.slug} animation="scale-in" delay={0.1 * idx}>
              <article id={s.slug} className="card scroll-mt-28 overflow-hidden">
                <div className="grid gap-8 p-8 md:p-10 lg:grid-cols-[1fr_1.3fr]">
                  <div>
                    ...
                    <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:items-center">
                      ...
                      <Link
                        ...
                        className="link-hover inline-flex items-center gap-1.5 px-2 py-2 font-semibold text-green-700"
                      >
